// Find an element in a vector of ordered elements using binary search
#include <iostream>
#include <vector>

using namespace std;

// The C++ library "algorithm" provides a function that can be used
...
// (The function is defined below, this is just the template prototype)
template <class C>
